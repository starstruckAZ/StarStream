...
const Hero: React.FC<HeroProps> = ({ onPlay }) => {
    return (
        <div style={{
            ...
            <div style={{ maxWidth: '750px', zIndex: 10, position: 'relative' }}>
                <div style={{
                    display: 'flex',
                    alignItems: 'center',
                    gap: '15px',
                    ...
                    <span style={{ opacity: 0.8 }}>A 360 VIEW ORIGINAL SPECIAL</span>
                </div>
                ...
                <p style={{
                    ...
                    Genies don't retire. They just get recycled. Join Niraj as he pulls
            ...
            <div style={{
                ...
                <div style={{ fontWeight: 800, fontSize: '1.2rem', marginBottom: '10px' }}>NIRAJ UNFILTERED</div>
